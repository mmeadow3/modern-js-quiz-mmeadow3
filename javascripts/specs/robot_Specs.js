...
describe("robot specs", () => {
	...
	it('should have 3 robot type functions', () =>  {
	...
	it('Each type should have 2 name functions assigned to it', () =>  {
	...
	it('Each should have defined health and damage', () => {
